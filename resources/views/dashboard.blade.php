                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-700 dark:text-gray-200">{{ \App\Models\Order::count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-700 dark:text-gray-200">{{ \App\Models\Product::count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-700 dark:text-gray-200">{{ \App\Models\User::count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-700 dark:text-gray-200">{{ \App\Models\Merchant::count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-10 w-10">
                                <img class="h-10 w-10 rounded-full object-cover" src="{{ $product->galleries->first()?->url ?? 'https://via.placeholder.com/150' }}" alt="{{ $product->name }}">
                            </div>
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $product->name }}</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">Rp {{ number_format($product->price, 0, ',', '.') }}</div>
                            </div>
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            ...
                            <div class="text-sm text-gray-500 dark:text-gray-400">on {{ $review->product->name }}</div>
