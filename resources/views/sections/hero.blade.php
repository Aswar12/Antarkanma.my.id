            ...
            <div class="text-center lg:text-left space-y-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    ...
                    <a href="https://wa.me/6287812379186"
                        target="_blank"
                        class="group relative inline-flex items-center justify-center bg-green-500 text-white px-8 py-3 rounded-full overflow-hidden transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:bg-green-600">
                        <span class="relative flex items-center space-x-2">
