<nav class="fixed w-full z-50 transition-all duration-300"
                ...
                <template x-for="(item, index) in [
                    ...
                    <a :href="item.href"
                       ...
                       :class="{ 'text-[#FF6600]': activeSection === item.href.substring(1) }">
                        ...
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#FF6600] transition-all duration-300 group-hover:w-full"></span>
                    </a>
                </template>
    ...
    <div x-show="mobileMenuOpen"
         ...
         class="md:hidden bg-[#020238] border-t border-white/10">
